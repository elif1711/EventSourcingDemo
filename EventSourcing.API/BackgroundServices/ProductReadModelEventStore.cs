...
{
    //Uygulama ayağa kalktığında bizim eventstorea subscribe olmamız lazım
    //proses sona erdiğinde de subsribtionın sona ermesi lazım
    //Burası uygulama ayağa kalktığında eventstoredan eventleri dinlemeye başlıcak,down olduğunda da sona erecek.
    ...
    public class ProductReadModelEventStore : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            // autoAck true ise Eventappeared metodunda exception yok ise o eventi gönderildi sayar.
